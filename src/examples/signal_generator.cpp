...
* @brief This file creates a Task responsible for connecting both SignalGeneratorComponent and the DigitalConvertComponent
* and its functionality can be checked by the widget::plot2d, which shows graphically the signals results
*
